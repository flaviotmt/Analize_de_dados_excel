...
def questoes_escala_linear(num_coluna, aba, aba_analise):

        #Inicialização de Dicionários para contabilizar votos
        id1 = {"0":0,"1":0, "2":0, "3":0, "4":0}
        id2 = {"0":0,"1":0, "2":0, "3":0, "4":0}
        id3 = {"0":0,"1":0, "2":0, "3":0, "4":0}
        id4 = {"0":0,"1":0, "2":0, "3":0, "4":0}
        id5 = {"0":0,"1":0, "2":0, "3":0, "4":0}
        id6 = {"0":0,"1":0, "2":0, "3":0, "4":0}
        masc = {"0":0,"1":0, "2":0, "3":0, "4":0}
        fem = {"0":0,"1":0, "2":0, "3":0, "4":0}
        ...
        for y in range(1, aba_analise.nrows):
            if aba_analise.cell_value(y, num_coluna) != "":
                if aba_analise.cell_value(y, 2) == "Entre 18 e 22 anos":
                    id1[str(int(aba_analise.cell_value(y, num_coluna)))] += 1
                elif aba_analise.cell_value(y, 2) == "Entre 23 e 27 anos":
                    id2[str(int(aba_analise.cell_value(y, num_coluna)))] += 1
                elif aba_analise.cell_value(y, 2) == "Entre 28 e 32 anos":
                    id3[str(int(aba_analise.cell_value(y, num_coluna)))] += 1
                elif aba_analise.cell_value(y, 2) == "Entre 33 e 37 anos":
                    id4[str(int(aba_analise.cell_value(y, num_coluna)))] += 1
                elif aba_analise.cell_value(y, 2) == "Entre 38 e 42 anos":
                    id5[str(int(aba_analise.cell_value(y, num_coluna)))] += 1
                elif aba_analise.cell_value(y, 2) == "Acima de 43 anos":
                    id6[str(int(aba_analise.cell_value(y, num_coluna)))] += 1

        #Identificando e listanto por genero
        for y in range(1, aba_analise.nrows):
            if aba_analise.cell_value(y, num_coluna) != "":
                if aba_analise.cell_value(y, 1) == "Masculino":
                    masc[str(int(aba_analise.cell_value(y, num_coluna)))] += 1
                elif aba_analise.cell_value(y, 1) == "Feminino":
                    fem[str(int(aba_analise.cell_value(y, num_coluna)))] += 1
        ...
        cabecalho = ["", "0 - Inseguro", "1- Pouco Seguro", "2 - Indiferente", "3 - Seguro", "4 - Muito Seguro"]
        ...
        for linha in range(len(coluna_1)):
            for coluna in range(len(cabecalho)-1):
                aba.write(linha+1, coluna+1, lista[linha][str(coluna)])

        #Listanto resultados por genero
        lista2 = [fem, masc]
        for linha in range(len(coluna_2)):
            for coluna in range(len(cabecalho)-1):
                aba.write(len(coluna_1)+linha+3, coluna+1, lista2[linha][str(coluna)])
